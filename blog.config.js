...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'hello，world,这里除了堆放个人杂物没有别的东西啦,你是怎么找到这的？',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CoconutShadow', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '想换个新的简介但是这碗米饭看起来好好吃，事已至此先吃饭吧🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'www.asteroidb612.space', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 个人网站', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '249816542@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/2337355?spm_id_from=333.1007.0.0', // B站主页
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '黔ICP备2023017769号-1', // 备案号 闽ICP备XXXXXXX
